...
| [check-coverage.mjs](check-coverage.mjs) | npm run test:coverage:check | Enforce 80% Istanbul thresholds from .nyc_output/ |
...
It queries hackathons:getHackathonBySlug and applicant:getApplicantRoutingState.
