...
| File | Covers |
| --- | --- |
| convex.test.ts | Registrations, initial review creation and profile decisions, submission snapshots, resume HTTP route, drafts, seed, cleanup |
...
| backend-authorization.test.ts | Auth boundaries, profile lifecycle, strict review-field schema and derived status, upload sessions, upload failure recovery, maintenance and migrations |
